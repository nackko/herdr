...
class ObserveUserActivityUseCaseSync : KoinComponent,
    BaseUseCaseSync<ObserveUserActivityUseCaseInput, Unit>() {
    private val repo: UserActivityTrackingRepository by inject()
    override fun run(): Response<Unit> {
        return repo.addUserActivityObserver(input!!.observer)
    }
}