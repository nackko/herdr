...
class UpdateWillGeoTrackUserActivityUseCaseAsync : KoinComponent,
    BaseUseCaseAsync<UpdateWillGeoTrackUserActivityUseCaseInput, Unit>() {
    private val repo: UserActivityTrackingRepository by inject()
    override suspend fun run(): Response<Unit> {

        return repo.onWillGeoTrackUserActivity(input!!.act, input!!.newState)
    }
}