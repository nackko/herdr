...
class ObserveGeoTrackUserActivityUseCaseSync : KoinComponent,
    BaseUseCaseSync<ObserveGeoTrackUserActivityUseCaseInput, Unit>() {
    private val repo: UserActivityTrackingRepository by inject()
    override fun run(): Response<Unit> {
        return repo.addGeoTrackActivityObserver(input!!.userActivity, input!!.observer)
    }
}