...
class RetrieveWillGeoTrackUserActivityUseCaseAsync : KoinComponent,
    BaseUseCaseAsync<RetrieveWillGeoTrackUserActivityUseCaseInput, Boolean>() {
    private val repo: HeadlessRepository by inject()
    override suspend fun run(): Response<Boolean> {
        return repo.retrieveWillGeoTrackUserActivity(input!!.act)
    }
}