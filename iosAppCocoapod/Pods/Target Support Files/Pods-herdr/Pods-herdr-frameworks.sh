...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../../app/build/cocoapods/framework/MultiPlatformLibrary.framework"
  install_dsym "${PODS_ROOT}/../../app/build/cocoapods/framework/MultiPlatformLibrary.framework.dSYM"
